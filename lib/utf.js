...
var makeJson = function(cp) {
    ...
    var utf32 = cp;
    var final = {
            'ascii': {'hex': ascii.toString(16), 'bin': ascii.toString(2)},
            'utf8':  {'hex': utf8.toString(16), 'bin': utf8.toString(2)},
            'utf16':  {'hex': utf16.toString(16), 'bin': utf16.toString(2)},
            'utf32':  {'hex': utf32.toString(16), 'bin': utf32.toString(2)},
            'glyph': char};
