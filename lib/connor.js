var seperate_every_8 = function(str) {
    var times = str.length / 8;
    var ret = '';
    for (var i = 0; i < times; i++) {
        ret += ' ' + str.slice(i * 8, i * 8 + 8);
    }
    return ret;
};
...
//  cpSpan.innerHTML = cpBitStr;
    ...
    var html8 = "";
    if(len8 < 9) {
        utf8Elem.html("<span>" + seperate_every_8(utf8BitStr) + "</span>");
    }

    utf8Elem.html("<span>" + seperate_every_8(utf8BitStr) + "</span>")
    utf16Elem.html("<span>" + seperate_every_8(utf16BitStr) + "</span>")
    utf32Elem.html("<span>" + seperate_every_8(utf32BitStr) + "</span>")
}
